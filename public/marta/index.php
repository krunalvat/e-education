...
<script>window.gtranslateSettings = {"default_language":"it","detect_browser_language":true,"languages":["it","en","fr","de","es","pt","ru"],"wrapper_selector":".gtranslate_wrapper","flag_size":24}</script>
...
// crea variabili nome categoria (nomi1 - nomicompleti1)
	${"numerocat$key"} = $campo0a;
	${"nomi$key"} = $campo2a;
...
// modificare per sequenza Tab
$ncat = $key;

for ($na = 0; $na <= $ncat; ++$na) {
	
// fine modificare per sequenza Tab
