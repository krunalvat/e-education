...
$qrlink = "www.menumio.it/$foldermenu";

if ($key == 0) $riga = "0";

$array_righi = file($my_azienda_txt);
foreach($array_righi as $key => $capi){
 list($campo0, $campo1, $campo2, $campo3, $campo4, $campo5, $campo6, $campo7, $campo8, $campo9, $campo10, $campo11, $campo12, $campo13, $campo14, $campo15) = explode("|", $capi);
...
// convere in rgba con trasparenza
 $colorehex = hex2rgba($colore, 0.6);
...
.bgimg {
  ...
  background-image: linear-gradient(<?php echo $colorehex; ?>, <?php echo $colorehex; ?>), url("<?php echo $sfondo; ?>");
  min-height: 100%;
}
...
<a name="cart">
			...
			?>
				<div class="panel panel-default">
				  <div class="panel-heading">
					<h3 class="panel-title"><span class="glyphicon glyphicon-shopping-cart"></span> Carrello</h3>
				  </div>
			...
			?>
				...
				<div class="panel panel-default">
				  <div class="panel-heading">
					...
					<h3 class="panel-title"><span class="glyphicon glyphicon-check"> </span> Conferma Ordine</h3>
 ...
 <?php if(isset($_GET["pay"])) {
			...
			$mailhtml= "<html>
			<head>
			<title>Riepilogo ordine su $titolo menumio.it</title>
			</head>
			<body>
			<h4>
			<strong>
			...
			$mailhtml2= "<html>
			<head>
			<title>Nuovo ordine $titolo menumio.it</title>
			</head>
			<body>
			<h4>
			<strong>
...
if ($femail === null){ }
	...
	$to = "$femail";
    $subject = "Copia ordine $titolo menumio.it";
    $message = "$mailhtml";
...
if ($fdettagli === null){ }
	...
	$to = "$email";
    $subject = "Nuovo ordine $titoloda menumio.it";
    $message = "$mailhtml2";
	$headers = "MIME-Version: 1.0" . "\r\n";
    $headers .= "Content-type:text/html;charset=UTF-8" . "\r\b";
    $headers .= 'From: name' . "\r\n";
   ...
   echo '<script>alert("Ordine recapitato! Apri il carrello per i dettagli")</script>';
		...
		session_destroy();
			...
			<div class="panel panel-success">
			  <div class="panel-heading"><span class="glyphicon glyphicon-shopping-cart"></span> Ordine inviato!</div>
			  <div class="panel-body">
			  Gentile <strong><?php echo $fragionesociale; ?></strong>,<br>il tuo ordine è stato recapitato.<br>
			  <br> 
			  Grazie da <strong><?php $titolo ?> menumio.it</strong>
...
?>
<label for="sidebar-checkbox" class="sidebar-toggle" style="width:100px; position:fixed!important; z-index:999">
<center>
...
?>
  ...
  <br>
  &nbsp;&nbsp;&nbsp;&nbsp;<a href="./admin"><i style="color:black" class="fas fa-lock" style="font-size:18px"></i></a>
...
<br>
<h3 style="color:black; font-size:26px!important"><? echo $messaggioheader; ?></h3>
...
if ($key == 0) {
 echo ('
       <a style="color:'.$colore.'" style="colore:$colore" href="javascript:void(0)" onclick="openMenu(event, \''.$campo2.'\');" id="myLink">
        <div class="w3-col s4 tablink w3-padding-large w3-hover-red"><strong>'.$campo2.'</strong></div>
      </a>
 ');
}
else {
...
$immaginetab = ('');	
	...
	echo ($immaginetab.'<br><br><h3>'.$campo2.'</h3>
...
<p class="w3-text-grey">'.$campo4.'
	  ...
	  <form action="?" method="post">
							<div class = "w3-right w3-tag input-group" style="width:160px;">
...
if (empty($sitoweb)) {
 ...
 <br><br>
  ...
  <h6>Menu digitale realizzato con <a style="color:<?php echo $colore ?>" href="https://www.menumio.it">Menumio</a></h6>
