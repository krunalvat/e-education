...
$extracode = $campo6l;
 ...
 if ($varcolore != null) {
  ...
  $coloreh3 = "color:$colore!important;";
	 ...
	 $backgrounddef2 = "background-color: $colore!important;";
 }
...
// se default
$sfondo = $path2;
$colorehex = hex2rgba($colore, 0.2);
$colorehex2 = hex2rgba($colore, 0.8);
} else {
// se upload
$sfondo = $path;
$colorehex = hex2rgba($colore, 0.2);
...
if(count($files) == 2) {
echo ('<h1 translate="no"><br><br>'.$titolo.'<br><br></h1>');
} else {
...
<br>
<h4 style="color:black; font-size:26px!important"><? echo $messaggioheader; ?></h4>
...
<div translate="no">
 ...
 <br><br>
  ...
  <h6>Menu digitale realizzato con <a style="color:<?php echo $colore ?>" href="https://www.qr7.it" translate="no"> QR7</a></h6>
